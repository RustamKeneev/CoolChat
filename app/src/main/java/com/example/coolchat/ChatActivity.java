...
import com.example.coolchat.adapters.ChatMessageAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageListView = findViewById(R.id.list_view);
        List<ChatMessage> awesomeMessages = new ArrayList<>();
        adapter = new ChatMessageAdapter(this, R.layout.item_message,
                awesomeMessages);
